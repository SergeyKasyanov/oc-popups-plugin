...
namespace SergeyKasyanov\Popups\Behaviors;
...
class PopupController extends ControllerBehavior
{
    ...
    protected function makePopupsConfigs(): void
    {
        foreach (array_keys($this->popupDefinitions) as $definition) {
            ...
            switch ($this->popupDefinitions[$definition]->type) {
                ...
                case self::TYPE_CONTENT:
                    ...
                    if (!($popupConfig->contentPartial ?? $popupConfig->content ?? null)) {
                        throw new SystemException(Lang::get(
                            'sergeykasyanov.popups::lang.config.content_or_content_partial',
                ...
                default:
                    throw new SystemException(Lang::get(
                        'sergeykasyanov.popups::lang.config.unknown_popup_type',
                        ['definition' => $definition]
                    ));
            }
    ...
    {
        return [
            'closeBtnLabel' => $popupConfig->closeBtnLabel ?? Lang::get('sergeykasyanov.popups::lang.close'),
